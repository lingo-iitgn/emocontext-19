...
class classifier(nn.Module):
    ...
    '''
    def __init__(self, VOCAB_SIZE, EMBEDDING_DIM, HIDDEN_DIM, ENC_OUTPUT_DIM, ENC_N_LAYERS, BIDIRECTIONAL,OUTPUT_CLASSES):
        super().__init__()
...
if __name__=="__main__":
    ...
    iter_train = data.BucketIterator(train_emo,batch_size=TRAIN_BATCH_SIZE,train=True,repeat=True,shuffle=True,device=device)
    ...
    ####### ARCITECTURE INIT #######
    emo_class = classifier(len(src.vocab), EMBEDDING_DIM, HIDDEN_DIM, ENC_OUTPUT_DIM, ENC_N_LAYERS, BIDIRECTIONAL,len(tgt.vocab)).to(device)
